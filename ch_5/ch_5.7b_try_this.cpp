...
int main()
{
    ...
    // Set high temperature and low temperature to near impossible levels
    // Highest recorded temp on Earth is 136F and lowest is ~128.6F
    double sum = 0;
    double high_temp = -300;
    double low_temp = 300;
