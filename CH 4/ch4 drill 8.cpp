...
// Prompts user for a value with a unit.  It will convert all values to equivalent value in centimeters and determine the largest & smallest input.
...
int main()
{
    ...
    while (cin >> x >> unit) {
        ...
        else if (cm_conversion(x, unit) > largest) {
