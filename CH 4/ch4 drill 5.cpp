...
// enter two doubles and spits doubles back in increasing value until non-double such as '|' is entered. If doubles are equal it will indicate as such.
// threshold of 1.0/100
