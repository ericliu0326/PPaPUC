...
// to equivalent value in meters and determine the largest & smallest input.
...
int main()
{
    double x = 0;
    string unit = " ";
    cout << "Please enter a number followed by a unit. Valid units are 'cm', 'm', 'in', 'ft' (i.e., 10 m)\n";
    cin >> x >> unit;
